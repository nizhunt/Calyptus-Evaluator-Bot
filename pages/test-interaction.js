      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 mt-8">
          ...
          <ol className="list-decimal list-inside space-y-2 text-yellow-700">
            <li>Start recording using the "Start Recording" button above</li>
            <li>Try interacting with all the test components below</li>
            <li>
              Check if buttons are clickable, inputs are typeable, dropdowns
              work, and scrolling functions
            </li>
            <li>
              If any component becomes unresponsive during recording, that
              indicates an overlay issue
            </li>
