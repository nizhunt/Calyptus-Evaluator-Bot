...
export class UploadManager {
  constructor(recordingId, handleUploadUrl, headers, sessionId) {
  ...
  async upload(blob, mimeType) {
    ...
    const stableSessionId = this.sessionId || this.recordingId;
    const filename = `recordings/${stableSessionId}.webm`;
