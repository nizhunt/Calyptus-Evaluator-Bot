...
export class ScreenRecorder {
    ...
    async stopAndCollectAudioChunks() {
        ...
        if (!this.preferredBackupAudioUrl) {
            ...
            this.logTrace('audio_chunks:backup_primary_selected', {
                url: this.preferredBackupAudioUrl,
            });
        }
        const uploadedUrls = this.preferredBackupAudioUrl
            ? [this.preferredBackupAudioUrl]
            : this.getOrderedUploadedAudioChunkUrls();
